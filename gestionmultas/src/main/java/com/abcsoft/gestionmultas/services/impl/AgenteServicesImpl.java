...
package com.abcsoft.gestionmultas.services.impl;
...
import com.abcsoft.gestionmultas.services.AgenteServices;
...
public class AgenteServicesImpl implements AgenteServices{
	...
	static {
		...
		Agente agente1 = new Agente(100L,"Pep�n","G�lvez","Ridruejo");
		Agente agente2 = new Agente(101L,"Honorio","Mart�n","Salvador");
	...
	public Agente create(Agente agente) {
		...
		if (agente.getCodigo() != null) {
			throw new IllegalArgumentException("El c�digo ha de ser nulo");
		}
